...
item_table = {
    ...
    'A button':                                        ('Item',     True,  0xE2, None),
    'Cup button':                                      ('Item',     True,  0xE3, None),
    'Cdown button':                                    ('Item',     True,  0xE4, None),
    'Cleft button':                                    ('Item',     True,  0xE5, None),
    'Cright button':                                   ('Item',     True,  0xE6, None),
