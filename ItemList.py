...
item_table = {
    ...
    'Reverse controls Trap':                           ('Item',     None,  0xD4, {'junk': 0}),
    'Healing Trap':                                    ('Item',     None,  0xD5, {'junk': 0}),
    'Slow Trap':                                       ('Item',     None,  0xD6, {'junk': 0}),
    'Fast Trap':                                       ('Item',     None,  0xD7, {'junk': 0}),
    'C buttons Trap':                                  ('Item',     None,  0xD8, {'junk': 0}),
    'No Z Trap':                                       ('Item',     None,  0xD9, {'junk': 0}),
    'No B Trap':                                       ('Item',     None,  0xDA, {'junk': 0}),
    'Sound Trap':                                      ('Item',     None,  0xDB, {'junk': 0}),
    'Shock Trap':                                      ('Item',     None,  0xDC, {'junk': 0}),
    'Bonk Trap':                                       ('Item',     None,  0xDD, {'junk': 0}),
    'Textbox Trap':                                    ('Item',     None,  0xDE, {'junk': 0}),
    'Rainbow Trap':                                    ('Item',     None,  0xDF, {'junk': 0}),
    'Interface Trap':                                  ('Item',     None,  0xE0, {'junk': 0}),
    'Earthquake Trap':                                 ('Item',     None,  0xE1, {'junk': 0}),
