...
item_table = {
    ...
    'Ocarina A Button':                                ('Item',     True,  0xE2, None),
    'Ocarina Cup Button':                              ('Item',     True,  0xE3, None),
    'Ocarina Cdown Button':                            ('Item',     True,  0xE4, None),
    'Ocarina Cleft Button':                            ('Item',     True,  0xE5, None),
    'Ocarina Cright Button':                           ('Item',     True,  0xE6, None),
