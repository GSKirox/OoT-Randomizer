...
hintTable = {
    ...
    'Reverse controls Trap':                                    ([""], "a Reverse controls Trap", 'item'),
    'Healing Trap':                                             ([""], "a Healing", 'item'),
    'Slow Trap':                                                ([""], "a Slow Trap", 'item'),
    'Fast Trap':                                                ([""], "a Fast Trap", 'item'),
    'C buttons Trap':                                           ([""], "a C buttons Trap", 'item'),
    'No Z Trap':                                                ([""], "a No Z Trap", 'item'),
    'No B Trap':                                                ([""], "a No B Trap", 'item'),
    'Sound Trap':                                               ([""], "a Sound Trap", 'item'),
    'Shock Trap':                                               ([""], "a Shock Trap", 'item'),
    'Bonk Trap':                                                ([""], "a Bonk Trap", 'item'),
    'Textbox Trap':                                             ([""], "a Textbox Trap", 'item'),
    'Rainbow Trap':                                             ([""], "a Rainbow Trap", 'item'),
    'Interface Trap':                                           ([""], "an Interface Trap", 'item'),
    'Earthquake Trap':                                          ([""], "an Earthquake Trap", 'item'),
