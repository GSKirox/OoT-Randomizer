...
item_row_t item_table[] = {
    ...
    [0xE2] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x903D, 0x0197, 0x7E, no_upgrade, unlock_ocarina_note, 0, -1), // Ocarina A
    [0xE3] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x903E, 0x0198, 0x7F, no_upgrade, unlock_ocarina_note, 1, -1), // Ocarina C up
    [0xE4] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x903F, 0x0198, 0x80, no_upgrade, unlock_ocarina_note, 2, -1), // Ocarina C down
    [0xE5] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9040, 0x0198, 0x81, no_upgrade, unlock_ocarina_note, 3, -1), // Ocarina C left
    [0xE6] = ITEM_ROW(0x53,      GILDED_CHEST, 0x41, -1, 0x9041, 0x0198, 0x82, no_upgrade, unlock_ocarina_note, 4, -1), // Ocarina C right
};
